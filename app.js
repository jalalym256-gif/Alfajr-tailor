...
async function printBothTemplates(index) {
    if (index < 0 || index >= customers.length) return;
...
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛`;
    ...
    printWindow.document.write(`
        <html><head><style>
            body { font-family: 'Courier New'; white-space: pre; 
                   font-size: 12px; direction: rtl; margin: 0; padding: 10px; }
            @media print { body { margin: 0; padding: 0; } }
        </style></head><body>${label}<br><br>${invoice}</body></html>
    `);
    printWindow.document.close();
    printWindow.focus();
